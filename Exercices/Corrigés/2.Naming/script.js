...
/*  
    ❌X1
    LET UsErNaMe = "John";  // false, keyword sensible à la casse   
    const _id = 99;  // true
    let class = true; // false mot clé réservé
    const isAdult = true; // true
    const $card = {name: card, content: "Lorem ipsum"}; // true
    let 1452 = 1452; // false, ne peut commencer par un chiffre
    const sum41 = "music"; // true
*/
...
// isModerator = false;
//C.
// salaries = [2450,1850,4712,3254,2000,1578]
//D. 
/*
currentWeather = {
    temperature : 27,
...
// scrollHeight = 4251
// F
// alertMessage = "Vous ne pouvez pas faire ça"
// G
...
// J
/* function addLoader/addAnimation(){}*/
//]
